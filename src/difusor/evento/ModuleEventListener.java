 ...
 * módulos, capturá-los e os retransmitir a todos os módulos, incluindo aquele que
 * gerou o evento. 
 */
...
public interface ModuleEventListener extends EventListener {
 ...
 /**
  * Método chamado de dentro do módulo para notificar ao broadcaster que ocorreu
  * um evento que precisa ser disseminado pelo sistema.  Recebe um objeto IgrafEvent 
  * e o redistribui a todos os módulos do programa.
  * @param e
  */
