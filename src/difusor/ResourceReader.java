...
public class ResourceReader {
 ...
 public ResourceReader (String table) {
  resourceBundleGeneralMessages = ResourceBundle.getBundle(table);
  }

 /**
  * Construtor alternativo utilizado para testar a ferramenta de 
  * internacionalização padrão do Java... e funciona bem!
  * @param i
  */
 public static void setLanguage (int language) {
  ...
  resourceBundleGeneralMessages = ResourceBundle.getBundle("resources/StringsTable", l);
  }


 public static String getString (String value) {
  try {
   return resourceBundleGeneralMessages.getString(value);
