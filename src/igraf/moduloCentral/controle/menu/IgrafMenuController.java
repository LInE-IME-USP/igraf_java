...
public abstract class IgrafMenuController extends CommunicationController {
 ...
 /**
  * Recebe uma string que é um comando, o rótulo do item de menu, indicando
  * que ação deve ser realizada em algum ponto do sistema.  O valor desta
  * string deve ser usado para definir que subtipo de IgrafEvent deve ser
  * enviado ao sistema de difusão de eventos e, consequentemente, determinar
  * quais objetos ouvintes serão afetados pela recepção deste evento.
  * @param comando
  */
