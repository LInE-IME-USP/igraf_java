...
public class IgrafMenuEdicaoEvent extends CommunicationEvent implements ModuloCentralDisseminavelEvent, EventoRegistravel, ModuloJanelasDisseminavelEvent {
 ...
 // o ideal é deixar o comando dos menus baseado nos nomes já que, assim, ao se acrescentar novos menus, o teste fica trivial
 ...
 public String getDescription () {
  ...
  return ResourceReader.msgComVar("msgInternalChangeClickMenu","OBJ",msgVet); // "Evento gerado na classe " + getSource() + " com o objetivo de notificar a interação (clique) do usuário no menu " + "MenuEdicao"
  }
